...
const drugDatabase = [
  ...
  { name: "Fycompa", cabinet: "J", section: "drawer2", row: 1, col: 2, rowSpan: 2, stripSize: 14, boxSize: 100 },
  { name: "Catilon", cabinet: "J", section: "drawer2", row: 1, col: 3, rowSpan: 2, stripSize: 21, boxSize: 100 },
  { name: "Cinnazine", cabinet: "J", section: "drawer2", row: 3, col: 1, stripSize: 10, boxSize: 100 },
  { name: "Advagraf 1mg", cabinet: "J", section: "drawer2", row: 3, col: 2, stripSize: 10, boxSize: 50 },
  { name: "Splotin 50mg", cabinet: "J", section: "drawer2", row: 3, col: 3, stripSize: 10, boxSize: 30 },
  { name: "Doxymycin", cabinet: "J", section: "drawer2", row: 4, col: 1, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Takepron", cabinet: "J", section: "drawer2", row: 4, col: 2, rowSpan: 2, stripSize: 14, boxSize: 28 },
  { name: "Mopride", cabinet: "J", section: "drawer2", row: 4, col: 3, rowSpan: 2, stripSize: 21, boxSize: 100 },

  // ========== I 櫃 ==========
  // 抽屜 1
  { name: "Azilect", cabinet: "I", section: "drawer1", row: 1, col: 1, rowSpan: 2, stripSize: 10, boxSize: 30 },
  { name: "Doxaben 2mg", cabinet: "I", section: "drawer1", row: 1, col: 2, rowSpan: 2, stripSize: 10, boxSize: 30 },
  { name: "Denosin", cabinet: "I", section: "drawer1", row: 1, col: 3, rowSpan: 3, stripSize: 10, boxSize: 100 },
  { name: "Suzin", cabinet: "I", section: "drawer1", row: 3, col: 1, stripSize: 10, boxSize: 100 },
  { name: "Sigmart", cabinet: "I", section: "drawer1", row: 3, col: 2, stripSize: 10, boxSize: 100 },
  { name: "Concor 5", cabinet: "I", section: "drawer1", row: 4, col: 1, rowSpan: 2, stripSize: 10, boxSize: 30 },
  { name: "Sandel", cabinet: "I", section: "drawer1", row: 4, col: 2, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Herbesser", cabinet: "I", section: "drawer1", row: 4, col: 3, rowSpan: 2, stripSize: 10, boxSize: 100 },
  // 抽屜 2
  { name: "Calcium Carbonate", cabinet: "I", section: "drawer2", row: 1, col: 1, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Rytmonorm", cabinet: "I", section: "drawer2", row: 1, col: 2, rowSpan: 2, stripSize: 10, boxSize: 60 },
  { name: "Meletin", cabinet: "I", section: "drawer2", row: 1, col: 3, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Avodart", cabinet: "I", section: "drawer2", row: 3, col: 1, stripSize: 10, boxSize: 30 },
  { name: "U-Ca", cabinet: "I", section: "drawer2", row: 3, col: 2, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Femara", cabinet: "I", section: "drawer2", row: 3, col: 3, stripSize: 10, boxSize: 30 },
  { name: "Pletaal", cabinet: "I", section: "drawer2", row: 4, col: 1, stripSize: 10, boxSize: 50 },
  { name: "Alfacalcidol", cabinet: "I", section: "drawer2", row: 4, col: 3, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Midorine", cabinet: "I", section: "drawer2", row: 5, col: 1, stripSize: 10, boxSize: 100 },
  { name: "Xarelto 10mg", cabinet: "I", section: "drawer2", row: 5, col: 2, stripSize: 10, boxSize: 28 },

  // ========== H 櫃 ==========
  // 抽屜 1
  { name: "Cofarin 1mg", cabinet: "H", section: "drawer1", row: 1, col: 1, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Antiasth", cabinet: "H", section: "drawer1", row: 1, col: 2, rowSpan: 2, stripSize: 6, boxSize: 100 },
  { name: "Eliquis", cabinet: "H", section: "drawer1", row: 1, col: 3, rowSpan: 2, stripSize: 14, boxSize: 60 },
  { name: "Baktar", cabinet: "H", section: "drawer1", row: 3, col: 1, stripSize: 10, boxSize: 20 },
  { name: "Cordarone", cabinet: "H", section: "drawer1", row: 3, col: 2, rowSpan: 2, stripSize: 15, boxSize: 30 },
  { name: "Meptin", cabinet: "H", section: "drawer1", row: 3, col: 3, stripSize: 10, boxSize: 100 },
  { name: "Cephalexin", cabinet: "H", section: "drawer1", row: 4, col: 1, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Userm", cabinet: "H", section: "drawer1", row: 4, col: 3, stripSize: 10, boxSize: 100 },
  { name: "Colchicine", cabinet: "H", section: "drawer1", row: 5, col: 2, stripSize: 10, boxSize: 100 },
  { name: "Allegra", cabinet: "H", section: "drawer1", row: 5, col: 3, stripSize: 10, boxSize: 100 },
  // 抽屜 2
  { name: "Glunormal", cabinet: "H", section: "drawer2", row: 1, col: 1, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Aleviatin", cabinet: "H", section: "drawer2", row: 1, col: 2, rowSpan: 2, stripSize: 21, boxSize: 100 },
  { name: "Glyxambi", cabinet: "H", section: "drawer2", row: 1, col: 3, rowSpan: 2, stripSize: 10, boxSize: 30 },
  { name: "Aspirin", cabinet: "H", section: "drawer2", row: 3, col: 1, stripSize: 10, boxSize: 100 },
  { name: "Tofranil 25mg", cabinet: "H", section: "drawer2", row: 3, col: 2, stripSize: 10, boxSize: 100 },
  { name: "Acemet", cabinet: "H", section: "drawer2", row: 3, col: 3, stripSize: 10, boxSize: 100 },
  { name: "Mobicam", cabinet: "H", section: "drawer2", row: 4, col: 1, rowSpan: 2, stripSize: 10, boxSize: 100 },
  { name: "Actos", cabinet: "H", section: "drawer2", row: 4, col: 2, rowSpan: 2, stripSize: 10, boxSize: 30 },
  { name: "Repaglinide", cabinet: "H", section: "drawer2", row: 4, col: 3, rowSpan: 2, stripSize: 21, boxSize: 100 },
  ...
  // 抽屜 2
  { name: "Epram", cabinet: "G", section: "drawer2", row: 1, col: 1, stripSize: 10, boxSize: 28 },
  ...
  { name: "Sirdalud", cabinet: "G", section: "drawer2", row: 2, col: 1, stripSize: 10, boxSize: 100 },
  { name: "Mesyrel", cabinet: "G", section: "drawer2", row: 2, col: 2, stripSize: 10, boxSize: 100 },
  { name: "Valdoxan", cabinet: "G", section: "drawer2", row: 2, col: 3, isBox: true, stripSize: 14, boxSize: 28 },
  { name: "Seroquel 25mg", cabinet: "G", section: "drawer2", row: 3, col: 1, stripSize: 10, boxSize: 100 },
  { name: "Abilify", cabinet: "G", section: "drawer2", row: 3, col: 2, stripSize: 10, boxSize: 30 },
  { name: "Apa-Mirtazapine", cabinet: "G", section: "drawer2", row: 3, col: 3, rowSpan: 2, stripSize: 10 },
  { name: "Tofranil 10mg", cabinet: "G", section: "drawer2", row: 4, col: 1, stripSize: 10, boxSize: 100 },
  { name: "Clozaril", cabinet: "G", section: "drawer2", row: 4, col: 2, stripSize: 10, boxSize: 100 },

  // ========== F 櫃 ==========
  // 左門
  { name: "Pacrea", cabinet: "F", section: "doorL", row: 1, col: 1, isBox: true, stripSize: 1, boxSize: 100 },
  // 抽屜 1
  { name: "Seroquel XR 200 mg/tab", cabinet: "F", section: "drawer1", row: 1, col: 1, stripSize: 10, boxSize: undefined },
  ...
  { name: "Keppra FC 500 mg/tab", cabinet: "F", section: "drawer1", row: 4, col: 2, stripSize: 10, boxSize: undefined },
  ...
  { name: "Stable 25 mg/tab", cabinet: "E", section: "drawer1", row: 3, col: 2, stripSize: 10, boxSize: undefined },
